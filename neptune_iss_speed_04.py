...
def get_time_difference(cro_image_1, cro_image_2):
    time_1 = get_time(cro_image_1)
    time_2 = get_time(cro_image_2)
...
# il ciclo salta da 0 a 50 a passi di dieci, le coppie di foto saranno 0,1 - 10, 11  e così via... 
for i in range(0, 2, 10):
    image_1 = "photo_" + str(i) + ".JPG"
    image_2 = "photo_" + str(i+1) + ".JPG"


# scelgo le fotografie
    # i nomi delle foto devono essere image_1 e image_2 
    im_1 = cv2.imread('photo_0683.JPG')
    im_2 = cv2.imread('photo_0684.JPG')
    crop_image_1 = Crop_image(im_1, 0.333)
    crop_image_2 = Crop_image(im_2, 0.333)
    ...
    print(get_time(im_1))
    print(get_time(im_2))
    time_difference = get_time_difference(im_1, im_2) # Get time difference between images
